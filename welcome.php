...
<body>
    <main>
        <div class="menu-side">
            <h6 id="menu-list-active-btn"><i class="bi bi-music-note-list"></i></h6>
            <a href="welcome.php" style="text-decoration:none"><h1>Melodix</h1></a>
            <div class="playlist ">
    ...
    <script>
        const menuListActiveBtn = document.querySelector('#menu-list-active-btn')
        const menuSide = document.getElementsByClassName('menu-side')[0];
        const songSide = document.getElementsByClassName('song-side')[0]

        menuListActiveBtn.addEventListener('click', () => {
        menuSide.style.transform = "unset";
        menuListActiveBtn.style.opacity = 0;
    })
        songSide.addEventListener('click', () => {
            if (window.innerWidth <= 980) { // Only close menu on smaller screens
        menuSide.style.transform = "translate(-100%)"; // Close the menu
        menuListActiveBtn.style.opacity = 1;
    }
        })
